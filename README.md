...
- **New change indicator** — fire icon (🔥) in Status and MR columns when the value recently changed (configurable duration, click to dismiss)
- **Settings** — configure default terminal (Terminal.app/iTerm2/Warp), repos directory, git diff tool, new change indicator duration, notifications, and clean up unused repos
