"""
Shared Unix socket communication utilities for Leap.

Provides a common send/receive pattern used by session_manager, leap_sender,
and other components that communicate with Leap servers via Unix sockets.
"""
