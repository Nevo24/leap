"""
Constants and shared configuration for Leap.
...
def _find_project_root() -> Path:
    """
    Find the Leap project root directory.
    ...
    # From src/leap/utils/constants.py → project root (4 levels up)
