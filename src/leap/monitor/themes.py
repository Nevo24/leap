...
_DAWN = Theme(
    ...
    input_bg='#ffffff',
    input_border='#d8dbe3',
    input_focus_border='#9ba4b5',
    icon_color='#94a3b8',
    header_bg='#f5f6f9',
    button_bg='#eef0f5',
    button_hover_bg='#e5e7ed',
    button_border='#e2e5eb',
    scrollbar_bg='#f8f9fc',
...
_VELVET = Theme(
    ...
    cell_bg='#1c1a26',
    cell_bg_alt='#232031',
    hover_bg='rgba(196, 167, 231, 16)',
    text_primary='#e9e4f4',
    text_secondary='#a39db8',
    text_muted='#6e6786',
    border_solid='#353150',
    border_subtle='rgba(196, 167, 231, 20)',
    accent_green='#8be0a4',
    accent_red='#f38ba8',
    accent_orange='#f5a97f',
    accent_blue='#c4a0f0',
    accent_yellow='#f0d68a',
    popup_bg='#232031',
    popup_border='#353150',
    input_bg='#1c1a26',
    input_border='#353150',
    input_focus_border='#c4a0f0',
    icon_color='#a39db8',
    header_bg='#131119',
    button_bg='#2a2740',
    button_hover_bg='#353150',
    button_border='#353150',
    scrollbar_bg='#171520',
    scrollbar_handle='#353150',
    scrollbar_handle_hover='#443f60',
    status_running='#8be0a4',
    status_permission='#f5a97f',
    status_input='#89b4fa',
    status_interrupted='#f0d68a',
    status_idle='#e9e4f4',
)
...
_LEAP = Theme(
    ...
    cell_bg='#fff9f0',
    cell_bg_alt='#f8efe2',
    hover_bg='rgba(232, 132, 40, 12)',
    text_primary='#3a2810',
    text_secondary='#8a6e48',
    text_muted='#b89868',
    border_solid='#e8cca0',
    border_subtle='rgba(232, 132, 40, 10)',
    accent_green='#16a34a',
    accent_red='#dc2626',
    accent_orange='#e88428',
    accent_blue='#e89020',
    accent_yellow='#f0a830',
    popup_bg='#fff9f0',
    popup_border='#e8cca0',
    input_bg='#fff9f0',
    input_border='#e0c498',
    input_focus_border='#e89020',
    icon_color='#b89868',
    header_bg='#f5dfc0',
    button_bg='#f0dcc0',
    button_hover_bg='#e8d0a8',
    button_border='#e0c498',
    scrollbar_bg='#fdf4e8',
    scrollbar_handle='#e0c498',
    scrollbar_handle_hover='#d0b080',
    status_running='#16a34a',
    status_permission='#e88428',
    status_input='#2563eb',
    status_interrupted='#ca8a04',
    status_idle='#3a2810',
    pr_merged_color='#7c3aed',
...
_AMBER = Theme(
    ...
    cell_bg='#211c14',
    cell_bg_alt='#28221a',
    hover_bg='rgba(245, 168, 35, 14)',
    text_primary='#f0e8d8',
    text_secondary='#a8977a',
    text_muted='#70634e',
    border_solid='#3d3428',
    border_subtle='rgba(245, 168, 35, 16)',
    accent_green='#4ade80',
    accent_red='#f87171',
    ...
    header_bg='#161210',
    button_bg='#2e271e',
    button_hover_bg='#3d3428',
    button_border='#3d3428',
    scrollbar_bg='#1c1710',
    scrollbar_handle='#3d3428',
    scrollbar_handle_hover='#504535',
    status_running='#4ade80',
    status_permission='#f5a623',
    status_input='#f5c842',
    status_interrupted='#fbbf24',
    status_idle='#f0e8d8',
)
...
_SYNTHWAVE = Theme(
    ...
    cell_bg='#150529',
    cell_bg_alt='#1b0a33',
    hover_bg='rgba(255, 46, 154, 18)',
    text_primary='#f4e9ff',
    text_secondary='#a585cf',
    text_muted='#6f4f9e',
    border_solid='#3d1f63',
    border_subtle='rgba(255, 46, 154, 22)',
    accent_green='#2bf5a0',
    accent_red='#ff3b6b',
    accent_orange='#ff8a4c',
    accent_blue='#2de2e6',
    ...
    input_bg='#150529',
    input_border='#3d1f63',
    input_focus_border='#ff2e9a',
    icon_color='#a585cf',
    header_bg='#0a0118',
    button_bg='#25113f',
    button_hover_bg='#321a52',
    button_border='#3d1f63',
    scrollbar_bg='#0f0220',
    scrollbar_handle='#3d1f63',
    scrollbar_handle_hover='#533080',
    status_running='#2bf5a0',
    status_permission='#ff8a4c',
    status_input='#4db8ff',
    status_interrupted='#ffd84d',
    status_idle='#f4e9ff',
    pr_merged_color='#c724ff',
)
...
_BARBIE = Theme(
    ...
    cell_bg='#fff5fa',
    cell_bg_alt='#ffeaf4',
    hover_bg='rgba(224, 33, 138, 12)',
    text_primary='#5c1138',
    text_secondary='#9d3a6b',
    text_muted='#c77ba0',
    border_solid='#f4b3d4',
    border_subtle='rgba(224, 33, 138, 14)',
    accent_green='#16a34a',
    accent_red='#dc2626',
    accent_orange='#ea580c',
    accent_blue='#cc1a7a',
    ...
    input_bg='#fff5fa',
    input_border='#f0a8cd',
    input_focus_border='#e0218a',
    icon_color='#cf6ba0',
    header_bg='#ffc4e3',
    button_bg='#ffd4ea',
    button_hover_bg='#ffc4e3',
    button_border='#f4b3d4',
    scrollbar_bg='#ffe3f1',
    scrollbar_handle='#f4a8cf',
    scrollbar_handle_hover='#ec88bb',
    status_running='#16a34a',
    status_permission='#ea580c',
    status_input='#2563eb',
    status_interrupted='#ca8a04',
